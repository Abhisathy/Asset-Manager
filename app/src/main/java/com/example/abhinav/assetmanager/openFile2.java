 ...
 */
public class openFile2 extends MainActivity1 {
    int i;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bb.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(p1) {
                    lv.setAdapter(new ArrayAdapter<String>(openFile2.this,
                    ...
                    if(!filedel.isEmpty()){
                        ...
                        Intent a = new Intent(openFile2.this, openFile2.class);
                        p1=true;
                        finish();
                        startActivity(a);
                    }
                        ...
                        if(FilesInFolder!=null) {
                            ...
                            lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                                public void onItemClick(AdapterView<?> parent, View v, int position, long id) {
                                    ...
                                    Uri uri = Uri.parse(Environment.getExternalStorageDirectory().getPath() + "/AssetManager/" + filename);
                            ...
                            lv.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
                                public boolean onItemLongClick(AdapterView<?> parent, View v, int position, long id) {
                                    ...
                                    View promptsView = li.inflate(R.layout.open_prompt1, null);
                                    ...
                                    alertDialog.show();
                                    Button b1 = (Button) promptsView.findViewById(R.id.share);
                    ...
                    search.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
                        ...
                        public boolean onQueryTextSubmit(String query) {
                            ...
                            if (FilesInFolder != null) {
                                ...
                                lv1.setAdapter(new ArrayAdapter<String>(openFile2.this,
                                        android.R.layout.simple_list_item_1, FilesInFolder));
                                        ...
                                        if (b2 != null) {
                                            b2.setOnClickListener(new View.OnClickListener() {
                                                ...
                                                public void onClick(View view) {
                                                    ...
                                                    boolean deleted = file.delete();
                                                    alertDialog.cancel();
                                                    Intent a = new Intent(openFile2.this, openfile.class);
                                                    finish();
                                                    startActivity(a);
                                                }
                                            });
    ...
    public void onCancel(View view){
        Intent a = new Intent(openFile2.this, MainActivity1.class);
        finish();
        startActivity(a);
    }
