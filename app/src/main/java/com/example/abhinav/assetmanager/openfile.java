...
public class openfile extends MainActivity1 {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bb.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(p1) {
                    lv.setAdapter(new ArrayAdapter<String>(openfile.this,
                    ...
                    if(!filedel.isEmpty()){
                        ...
                        Intent a = new Intent(openfile.this, openfile.class);
                        p1=true;
                        finish();
                        startActivity(a);
                    }
                        ...
                        fIn1.close();*/
                                    ...
                                    Intent a = new Intent(openfile.this, ScanFile.class);
                                    finish();
                                    a.putExtras(basket);
                                    startActivity(a);
                                    ...
                                    if (b1 != null) {
                                        b1.setOnClickListener(new View.OnClickListener() {
                                            ...
                                            public void onClick(View view) {
                                                ...
                                                Bundle basket = new Bundle();
                                                basket.putString("abc", filename);
                                                Intent a = new Intent(openfile.this, Main1Activity.class);
                                                finish();
                                                a.putExtras(basket);
                                                startActivity(a);
                                            }
                    ...
                    search.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
                        ...
                        public boolean onQueryTextSubmit(String query) {
                            ...
                            if (FilesInFolder != null) {
                                ...
                                lv1.setAdapter(new ArrayAdapter<String>(openfile.this,
                                        android.R.layout.simple_list_item_1, FilesInFolder));
    ...
    public void onCancel(View view) {
        Intent a = new Intent(openfile.this, MainActivity1.class);
        finish();
        startActivity(a);
    }
